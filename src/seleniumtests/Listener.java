...
public class Listener implements WebDriverListener {
	...
	public void afterAccept(Alert alert) {
		Reporter.log("Accepted the Alert Successfully");
	}
	...
	public void afterAlert(TargetLocator targetLocator, Alert alert) {
		Reporter.log("Alert Popup Successfully Arrived");
	}
	...
	public void afterClick(WebElement element) {
		Reporter.log("Clicked on WebElement Successfully");
	}

	@Override
	public void afterClose(WebDriver driver) {
		Reporter.log("Closed the Current Page Successfully");
	}
	...
	public void afterGetTitle(WebDriver driver, String result) {
		Reporter.log("Getting the current browser Title");
	}
	...
	public void afterSendKeys(Alert alert, String text) {
		Reporter.log("SendKeys entered Successfully");
	}
	...
	public void beforeAlert(TargetLocator targetLocator) {
		Reporter.log("Alert Popup is Arriving");
	}
	...
	public void beforeClick(WebElement element) {
		Reporter.log("Clicking on the WebElement");
	}

	@Override
	public void beforeClose(WebDriver driver) {
		Reporter.log("Closeing the Current Page");
	}
	...
	public void beforeDismiss(Alert alert) {
		Reporter.log("Dismissing the Alert");
	}
	...
	public void beforeGetTitle(WebDriver driver) {
		Reporter.log("Performing the Title before executing");
	}
	...
	public void beforeSendKeys(Alert alert, String text) {
		Reporter.log("Entering the Keys in the WebElement");
	}
